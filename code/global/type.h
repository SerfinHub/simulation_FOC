...
struct ALARM_BITS_t
{
    std::uint32_t U_dc1_H : 1;
    std::uint32_t U_dc1_L : 1;
    std::uint32_t I_m1_H : 1;
    std::uint32_t I_m1_L : 1;
    std::uint32_t I_m2_H : 1;
    std::uint32_t I_m2_L : 1;
    std::uint32_t I_m3_H : 1;
    std::uint32_t I_m3_L : 1;
    std::uint32_t TZ_supply : 1;
    std::uint32_t PLL_ERR : 1;
    std::uint32_t RECT_ERR : 1;
    std::uint32_t FOC_ERR : 1;
    std::uint32_t rsvd1 : 20;
};
